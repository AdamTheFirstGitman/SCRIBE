...
export const metadata: Metadata = {
  metadataBase: new URL(process.env['NEXT_PUBLIC_APP_URL'] || 'https://scribe-frontend-qk6s.onrender.com'),
  title: {
    default: 'Plume & Mimir',
  ...
  openGraph: {
    type: 'website',
    locale: 'fr_FR',
    url: process.env['NEXT_PUBLIC_APP_URL'] || 'https://scribe-frontend-qk6s.onrender.com',
